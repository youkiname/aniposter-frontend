...
<div class="article-wrap">
	<img src="/logo.png" alt="Ani poster logo" class="home-logo">
	<h1>ANI POSTER</h1>
	<p>- телеграм-проект для размещения пользовательских постов, 
	посвященных аниме-тематике.</p>
	<p><a href="https://t.me/tolaptik">@tolaptik</a> - администратор.</p>
	<h3>Информация:</h3>
	<ul style="list-style: none;">
		<li><router-link to="/top">Глобальный топ</router-link></li>
